...
## 0:00 — Design the test around risk
...
## 0:34 — Use the accessible contract
...
## 1:08 — Observe the right request
...
## 2:17 — Verify the authoritative account
...
## 2:54 — Verify the transfer record
...
## 3:31 — Build insufficient funds separately
...
## 4:04 — Keep an idempotent intention
...
## 4:41 — Compare identity and effects
...
## 5:17 — Run with an honest outcome
