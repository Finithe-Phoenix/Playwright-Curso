...
## 0:38 — Confirm one Python environment
...
## 1:12 — Separate two HTTP responsibilities
...
## 2:26 — Authenticate the provided context
...
## 3:02 — Write the visible behavior
...
## 4:19 — Capture the rejection response
...
## 4:57 — Keep idempotency outside variation
...
## 6:08 — Preserve the original failure
...
## 6:46 — Explain your fixture graph
