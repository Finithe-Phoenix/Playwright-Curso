...
## 0:00 — Add a terminal protocol boundary
...
## 0:34 — Separate browser and terminal control
...
## 1:11 — Understand what the simulator displays
...
## 1:47 — Read the folder structure
...
## 2:26 — Install the prepared environment
...
## 3:04 — Start services in their own terminals
...
## 3:42 — Check a real terminal screen
...
## 4:17 — Identify the input and result fields
...
## 5:29 — Keep plaintext local to the simulator
...
## 6:07 — Run protocol tests independently
...
## 6:43 — Confirm the architecture checkpoint
