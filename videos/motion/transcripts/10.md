...
## 0:00 — Build a predictable terminal session
...
## 0:34 — Create the actual TNZ client
...
## 1:12 — Connect within the local boundary
...
## 2:26 — Require a ready keyboard too
...
## 3:00 — Validate and enter the reference
...
## 3:35 — Wait for the submitted reference
...
## 4:08 — Parse the labeled business values
...
## 5:19 — Always release the connection
...
## 5:57 — Test negative terminal outcomes
...
## 6:35 — Explain the adapter contract
