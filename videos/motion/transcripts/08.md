...
## 0:00 — Use a failure as evidence
...
## 0:34 — Start the defect on separate ports
...
## 1:09 — Run the intended failing case
...
## 2:16 — Confirm the request evidence
...
## 2:54 — Protect the monetary oracle
...
## 3:31 — Ask AI a bounded diagnostic question
...
## 4:10 — Validate the corrected path
...
## 4:45 — Design the CI job around readiness
...
## 5:20 — Retain evidence on failure
...
## 5:59 — Report a precise execution status
...
## 6:38 — Close the diagnostic loop
