...
## 0:00 — Follow one transfer across interfaces
...
## 0:40 — Prepare an isolated hybrid fixture
...
## 1:15 — Perform the actual browser transfer
...
## 1:52 — Extract the canonical correlation
...
## 2:30 — Call the adapter from Python
...
## 3:06 — Call the same boundary from TypeScript
...
## 3:44 — Call the same boundary from Java
...
## 4:20 — Assert every business value
...
## 4:59 — Keep ledger projection as another check
...
## 5:35 — Capture evidence before cleanup
...
## 6:13 — Add a meaningful negative case
...
## 6:48 — Review the hybrid checkpoint
