...
## 0:00 — Treat each test as an experiment
...
## 0:35 — Create only the data you own
...
## 1:13 — Keep the hook client separate
...
## 1:48 — Authenticate where the page lives
...
## 2:26 — Understand storage state reuse
...
## 3:38 — Verify ownership boundaries
...
## 4:15 — Place cleanup after evidence
...
## 4:52 — Handle partial setup failures
...
## 5:31 — Add concurrency only after isolation
...
## 6:10 — Ask AI to audit lifecycle edges
...
## 6:46 — Produce an isolation checklist
