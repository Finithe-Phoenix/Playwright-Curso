...
## 0:00 — Observe a distributed business event
...
## 0:34 — Inspect the three processes
...
## 1:12 — Understand the local transaction
...
## 1:48 — Capture identity from the response
...
## 2:24 — Assert commitment immediately
...
## 3:00 — Query the delayed projection
...
## 3:37 — Poll only the observation
...
## 4:17 — Do not replace progress with sleep
...
## 4:52 — Check duplicates after visibility
...
## 6:03 — Carry correlation into reporting
...
## 6:40 — State the distributed evidence
