...
## 0:00 — Choose the boundary deliberately
...
## 1:42 — Install a narrow route handler
...
## 2:20 — Exercise the user action once
...
## 2:54 — Inspect real state after the mock
...
## 3:30 — Remove the controlled boundary
...
## 4:03 — Compare two kinds of evidence
...
## 4:39 — Keep backend resilience separate
...
## 5:14 — Review generated mocks carefully
...
## 5:50 — Label the report precisely
...
## 6:28 — Choose the next useful test
